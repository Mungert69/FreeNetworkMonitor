# How To Setup Your Own Quantum Network Monitor

_July 2, 2022 by [Mahadeva](/)_

- In order to setup your Quantum Network Monitor you first need to login. Click the login button and create an account by clicking sign up. The email address you use will be used to send you alerts.
...
<img src="https://readyforquantum.com/img/login-and-add-host.gif" width="666" height="301" />
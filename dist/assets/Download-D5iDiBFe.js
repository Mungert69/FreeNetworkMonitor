...
`,P=()=>{const d=f(),t=w(y(d,"undefined/ping.svg")),[o,i]=a.useState(!1),[h,L]=a.useState(!1),u=()=>i(!0),p=()=>i(!1);return e.jsxs("div",{className:t.root,children:[e.jsx(m,{}),e.jsxs(k,{children:[e.jsx("title",{children:"Download Beta - Free Network Monitor App"}),e.jsx("meta",{name:"description",content:"Join the exclusive beta testing program for the Free Network Monitor Agent and Quantum Secure Agent apps to help shape their future."})]}),e.jsx(v,{position:"absolute",className:n(t.appBar,o&&t.appBarShift),children:e.jsxs(b,{className:t.toolbar,children:[h&&e.jsx(g,{small:!0}),e.jsx(r,{edge:"start",color:"inherit","aria-label":"open drawer",onClick:u,className:n(t.menuButton,o&&t.menuButtonHidden),size:"large",children:e.jsx(A,{})}),e.jsx(x,{}),e.jsx(s,{sx:{paddingLeft:4},component:"h1",color:"inherit",noWrap:!0,className:t.title,children:"Free Network Monitor"}),e.jsx(C,{})]})}),e.jsxs(M,{variant:"permanent",classes:{paper:n(t.drawerPaper,!o&&t.drawerPaperClose)},open:o,children:[e.jsx("div",{className:t.toolbarIcon,children:e.jsx(r,{onClick:p,size:"large",children:e.jsx(S,{})})}),e.jsx(l,{}),e.jsx(T,{children:e.jsx(N,{classes:t})}),e.jsx(l,{})]}),e.jsxs("main",{className:t.content,children:[e.jsx("div",{className:t.appBarSpacer}),e.jsxs(I,{maxWidth:"lg",className:t.container,children:[e.jsx(c,{container:!0,spacing:6,children:e.jsxs(c,{item:!0,xs:12,children:[e.jsx(s,{color:"primary",variant:"h3",gutterBottom:!0,children:"Beta Tester Download Portal"}),e.jsx(s,{variant:"h4",gutterBottom:!0,children:"Welcome Beta Testers!"}),e.jsx(s,{variant:"h6",color:"textSecondary",gutterBottom:!0,children:"You've been selected to participate in our exclusive beta testing program. Follow the steps below to get started."})]})}),e.jsx("hr",{}),e.jsx("div",{children:e.jsx(j,{children:F})}),e.jsx(D,{})]})]})]})},q=a.memo(P);export{q as default};
